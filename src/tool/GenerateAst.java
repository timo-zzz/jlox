...
public class GenerateAst {
    public static void main(String[] args) throws IOException {
        ...
        // Give a description of each type
    ...
    private static void defineAst(String outputDirectory, String baseName, List<String> types) throws IOException {
        String path = outputDirectory + "/" + baseName + ".java"; // baseName is the name of the file/class being created.

        PrintWriter writer = new PrintWriter(path, "UTF-8");

        // Write imports/package stuff
